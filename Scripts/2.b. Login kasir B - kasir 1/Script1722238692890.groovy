...
WebUI.click(findTestObject('Login_Sarirasa WebPOS/input_ID Sarirasa_inputNIK'))
...
WebUI.selectOptionByValue(findTestObject('Login_Sarirasa WebPOS/select_Tipe User Kasir 1Kasir 2Kasir 3Kasir_c131aa'), 'kasir_1', 
    true)

WebUI.selectOptionByValue(findTestObject('Login_Sarirasa WebPOS/select_Pilih Default PrinterPrinter HO (Gud_45e032'), '59', 
    true)
