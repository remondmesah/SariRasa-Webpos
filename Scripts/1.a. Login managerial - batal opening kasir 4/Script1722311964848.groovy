...
WebUI.setText(findTestObject('Login_Sarirasa WebPOS/input_ID Sarirasa_inputNIK'), '54760')
...
WebUI.selectOptionByValue(findTestObject('Login_Sarirasa WebPOS/select_Tipe User Kasir 1Kasir 2Kasir 3Kasir_c131aa'), 'kasir_4', 
    true)
...
WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/div_CASHIER'))

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/div_OPENING'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/h6_Masukkan Jumlah Nominal'), 
    'Masukkan Jumlah Nominal')

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/01. Nominal kasir/span_Rp 50.000'))

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/01. Nominal kasir/span_Hapus'))

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/01. Nominal kasir/span_Rp 100.000'))
...
String basePath = 'Object Repository/Menu Opening-Closing/Proses Opening/01. Nominal kasir/span_'
...
WebUI.click(findTestObject('Menu Opening-Closing/Proses Opening/div_Tutup'))
...
WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/div_OK-managerial'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/h2_Opening'), 'Opening!')

WebUI.verifyElementText(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/label_Nominal Cash Opening'), 
    'Nominal Cash Opening')

WebUI.verifyElementText(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/input_Nominal Cash Opening_input_opening'), 
    '')

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/button_Cancel'))

WebUI.click(findTestObject('Object Repository/Validasi Opening/div_Gagal menyimpan data'))

WebUI.click(findTestObject('Object Repository/Menu Opening-Closing/Proses Opening/svg_SOON_svg-inline--fa fa-times-circle fa-_f575ce'))
