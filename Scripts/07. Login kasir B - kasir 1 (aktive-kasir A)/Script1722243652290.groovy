...
/*
 WebUI.verifyElementText(findTestObject('Login_Sarirasa WebPOS/2.Validasi Login/div_Tidak dapat melakukan setting untuk printer'), 
 'Tidak dapat melakukan setting untuk printer..')
 */
WebUI.delay(3)
