...
WebUI.click(findTestObject('Menu Opening-Closing/div_CASHIER'))

WebUI.verifyElementPresent(findTestObject('Validasi Opening/History-Opening/div_SEDANG OPENING  di kasir_4  nominal  Rp5.000.000,-  by  SURIPTO  CLOSING  ORDER  SOON'), 
    0)
